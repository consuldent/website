    ...
    <main className="bg-[#F5F0E8]">
      <div className="container mx-auto py-16 px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <div className="inline-flex items-center gap-2 bg-[#6E2230] text-white px-4 py-2 rounded-full mb-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            <h2 className="text-2xl font-bold text-[#102032] mb-6">Patient Experience Mastery</h2>
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="bg-[#6E2230]/10 p-3 rounded-xl h-fit">
                  <Phone className="w-6 h-6 text-[#6E2230]" />
                </div>
                <div>
                  <h3 className="font-bold text-[#102032] mb-2">Phone Excellence</h3>
              ...
              <div className="flex gap-4">
                <div className="bg-[#102032]/10 p-3 rounded-xl h-fit">
                  <Users className="w-6 h-6 text-[#102032]" />
                </div>
                <div>
                  <h3 className="font-bold text-[#102032] mb-2">Seamless Onboarding</h3>
                  <p className="text-gray-600 text-sm">
              ...
              <div className="flex gap-4">
                <div className="bg-[#6E2230]/10 p-3 rounded-xl h-fit">
                  <Star className="w-6 h-6 text-[#6E2230]" />
                </div>
                <div>
                  <h3 className="font-bold text-[#102032] mb-2">Reviews & Referrals</h3>
                  <p className="text-gray-600 text-sm">
        ...
        <div className="mt-16 bg-[#6E2230] rounded-3xl p-8 md:p-12 text-white">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-white text-[#6E2230] px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white/90 transition-colors"
          >
